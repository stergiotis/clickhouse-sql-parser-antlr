...
func (v *BaseClickHouseParserVisitor) VisitAssignmentValues(ctx *AssignmentValuesContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseClickHouseParserVisitor) VisitAssignmentValue(ctx *AssignmentValueContext) interface{} {
	return v.VisitChildren(ctx)
}
